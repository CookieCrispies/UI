  ...
  const TooltipComponent = () => (
    <Box>
      ...
      <Box mb="16px">
        {TranslateString(
          999,
          'Whenever you successfully claim the bounty, you’re also helping out by activating the Auto CHOCO Pool’s compounding function for everyone.',
        )}
      </Box>
      <Box style={{ fontWeight: 'bold' }}>
        {TranslateString(999, `Auto-Compound Bounty: ${callFee / 100}% of all Auto CHOCO pool users’ pending yield`)}
      </Box>
    </Box>
  )
          ...
          <Flex flexDirection="column">
            <Flex alignItems="center" mb="12px">
              <Text fontSize="16px" bold color="textSubtle" mr="4px">
                {TranslateString(999, 'Auto CHOCO Bounty')}
              </Text>
              <Box ref={targetRef}>

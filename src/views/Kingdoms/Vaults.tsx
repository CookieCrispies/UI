      ...
      <div>
          <Route exact path={`${path}`}>
            {farmsStakedMemoized.map((farm) => (
                farm.isKingdomLocked ? <LockedKingdom  key={farm.pid} farm={farm} cakePrice={cakePrice} account={account} removed={false} bakePrice={bakePrice} beltPrice={beltPrice} CookieDen={CookieDen} realCakePrice={realCakePrice} bnbDividends={bnbDividends} /> :
                    <Kingdom key={farm.pid} farm={farm} cakePrice={cakePrice} account={account} removed={false} bakePrice={bakePrice} beltPrice={beltPrice} CookieDen={CookieDen} realCakePrice={realCakePrice} bnbDividends={bnbDividends} />
            ))}
          </Route>
          <Route exact path={`${path}/history`}>
            {farmsStakedMemoized.map((farm) => (
                farm.isKingdomLocked ? <LockedKingdom key={farm.pid} farm={farm} cakePrice={cakePrice} account={account} removed bakePrice={bakePrice} beltPrice={beltPrice} CookieDen={CookieDen} realCakePrice={realCakePrice} bnbDividends={bnbDividends} /> :
              <Kingdom key={farm.pid} farm={farm} cakePrice={cakePrice} account={account} removed bakePrice={bakePrice} beltPrice={beltPrice} CookieDen={CookieDen} realCakePrice={realCakePrice} bnbDividends={bnbDividends} />
            ))}
          </Route>
    ...
    <>
      <PageHeader>
        ...
        <Heading as="h2" color="secondary" mb="10px" style={{ textAlign: 'left' }}>
          Stake tokens for cross-platform farming plus Cookie rewards
        </Heading>
        ...
        <FeeWrapper>
          ...
          {/* <Flex justifyContent="space-between">
            <Text>Fee for Cookie Staking Kingdom BNB Dividends:</Text>
            <Text>3%</Text>
          </Flex> */}
         {/*  <Flex justifyContent="space-between">
          ...
          {/* <Flex justifyContent="space-between">
            <Text>Cookie Burn Rate:</Text>
            <Text>100% of Fees Buyback and Burn Cookie</Text>
          </Flex> */}
          {/* <Flex justifyContent="space-between">
      ...
      <Page className="k-container">
        <TotalStaked farms={farmsStakedMemoized} cakePrice={cakePrice} bakePrice={bakePrice} beltPrice={beltPrice} CookieDen={CookieDen} />
        <ControlContainer>
          <ViewControls>
            <ToggleWrapper>
        ...
        <div id="kingdoms">
          {/* farmsStakedMemoized.map((farm) => (
            <LockedKingdom key={farm.pid} farm={farm} cakePrice={cakePrice} account={account} removed={false} bakePrice={bakePrice} beltPrice={beltPrice} CookieDen={CookieDen} realCakePrice={realCakePrice} bnbDividends={bnbDividends} />
          )) */}
          {renderContent()}
        </div>
        <div ref={loadMoreRef} />

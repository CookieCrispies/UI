...
const LockedKingdom: React.FC<KingdomProps> = ({ farm, removed, cakePrice, account, bakePrice, beltPrice, CookieDen, realCakePrice, bnbDividends }) => {
  const [showExpandableSection, setShowExpandableSection] = useState(false)
    const [cakeVaultEarnings, setCakeVaultEarnings] = useState(null)

    // useswrimmutable to getCakeVaultEarnings from chain data called "chain-balance-locked-Cookie"
    useEffect(() => {
